    ...
    <section className="pt-32 pb-20 relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          ...
          alt={t('hero.imageAlt', 'Web Development')}
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-xl md:text-2xl text-white/90 mb-6 max-w-2xl mx-auto leading-relaxed drop-shadow-md">
          {t('hero.title', 'Помогаем запускать и развивать бизнес в цифровой среде')}
        </p>

        <p className="text-lg md:text-xl text-white/80 mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
          {t('hero.subtitle', 'Создаем современные и эффективные сайты, которые приносят результат')}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          >
            {t('hero.ctaPrimary', 'Оставить заявку')}
          </button>
          <button 
          ...
          >
            {t('hero.ctaSecondary', 'Наши работы')}
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
          <div className="text-center">
            ...
            <div className="text-white/80 text-sm md:text-base drop-shadow-md">
              {t('hero.stats.projects', 'Реализованных проектов')}
            </div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-white mb-2 drop-shadow-lg">
            ...
            <div className="text-white/80 text-sm md:text-base drop-shadow-md">
              {t('hero.stats.experience', 'Года опыта')}
            </div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-white mb-2 drop-shadow-lg">
            ...
            <div className="text-white/80 text-sm md:text-base drop-shadow-md">
              {t('hero.stats.clients', 'Довольных клиентов')}
            </div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-white mb-2 drop-shadow-lg">
            ...
            <div className="text-white/80 text-sm md:text-base drop-shadow-md">
              {t('hero.stats.support', 'Поддержка')}
            </div>
          </div>
        </div>
        ...
        <div className="animate-bounce">
          ...
          <p className="text-white/70 text-sm mt-2 drop-shadow-md">
            {t('hero.scrollHint', 'Листайте вниз')}
          </p>
        </div>
      </div>
    </section>
